...
The average that borwnlow is making is 281.17. 95% confidence interval is 2 SD below the mean and above the median which is 210 for below and 350 above .
...
plot(sorted_b_low, type = "l", xlab = "Index", ylab = "Value",
     ...
     main = "Line Plot of Blow Numerical Vector")
...
```
the new standard devaition is 53.93 median is 6.37 the min is -139.16 and is below
...
```
the new standard is 57.03 and median is -5.00. th min is -183.04.
